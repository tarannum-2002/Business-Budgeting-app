...
return(
    <Components.Container>
            ...
            <Components.Form onSubmit={EnterDetails}>
                ...
                <Components.Input type='number' placeholder='Money Spent' value={MoneySpent} onChange={(e) => setMoney(e.target.value)}/>
                <Components.Input type='text' placeholder='Description' value={Description} onChange={(e) => setDesc(e.target.value)}/>

                <Components.Button type="submit" value="EnterDetails" >Enter Details</Components.Button>
            </Components.Form>
